...
const AboutContent = () => {
  ...
  return (
    <div className='text-left px-12 mx-12'>
      <motion.section
      ...
      >
        ...
        <p className="text-lg">
          While I am not coding or working on a project, I enjoy rock climbing and spending time with friends! I am a foodie, so I love trying new foods and experiencing different flavors.
        </p>
      </motion.section>
      <motion.section
        className="my-4 mx-12"
      ...
      >
        ...
        <p className="text-lg">
          Feel free to reach out, so we can explore and work on something cool together! Contact me on:
          ...
          or send an <a href="mailto:ssui@vols.utk.edu" className="text-blue-500 hover:text-blue-700"> email</a>!
        </p>
      </motion.section>
    </div>
  );
